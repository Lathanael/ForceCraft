 ...
 *
 */
public class DemoteButton extends GenericButton implements Button {

	public DemoteButton(String name) {
		super(name);
	}
	...
	public void onButtonClick(ButtonClickEvent event) {
		...
		fPlayer.decRank();
		FCUserInterface.adminField.output.setText("Successfully demoted Player: "
